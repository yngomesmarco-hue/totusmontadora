  ...
  return (
    <section className="py-20 bg-background">
      <div className="container mx-auto px-6 max-w-6xl">
        ...
        <p className="text-center text-muted-foreground mb-12 max-w-4xl mx-auto text-lg">
        ...
        <div className="space-y-4">
          ...
          <div className="border border-border rounded-lg overflow-hidden">
            <button
              ...
              className={`w-full flex items-center justify-between p-6 text-left transition-colors ${
                openSection === "missao" ? "bg-neon text-black" : "bg-card text-foreground hover:bg-card/80"
              }`}
            >
          ...
          <div className="border border-border rounded-lg overflow-hidden">
            <button
              ...
              className={`w-full flex items-center justify-between p-6 text-left transition-colors ${
                openSection === "visao" ? "bg-neon text-black" : "bg-card text-foreground hover:bg-card/80"
              }`}
            >
              <span className="text-xl font-bold flex items-center gap-2">
          ...
          <div className="border border-border rounded-lg overflow-hidden">
            <button
              ...
              className={`w-full flex items-center justify-between p-6 text-left transition-colors ${
                openSection === "valores" ? "bg-neon text-black" : "bg-card text-foreground hover:bg-card/80"
              }`}
            >
              <span className="text-xl font-bold flex items-center gap-2">
